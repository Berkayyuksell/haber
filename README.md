backend run : uvicorn main:app --reload frontend run : npm start backend için gerekli olan model ve label encoder: https://drive.google.com/drive/folders/12NLA-PJjFdNxANZwKoz0QaW_3P2Pz50r?usp=sharing
